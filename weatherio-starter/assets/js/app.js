            ...
            fetchData(url.geo(searchField.value), function(locations) {
                ...
                for (const {name, lat, lon, country, state} of locations) {
                    ...
                    <span class="m-icon">location_on</span>
                        ...
                        <a href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" aria-label="${name}
            ...
            for(const[index, data] of forecastList.entries()) {
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                            ...
                            <img src="./assets/images/weather_icons/01n.png" width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style="transform: rotate(${windDirection - 180})">
